<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.areaName" :placeholder="$t('table.areaName')" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.areaName')" prop="areaName" min-width="200px" />
      <el-table-column :label="$t('table.sortNo')" prop="sortNo" width="200px" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="60%"  top="10px">
      <el-form ref="dataForm" size="small" :rules="rules" :model="temp" label-position="right" label-width="80px" style="width: 400px; margin-left:30px;">
        ...
        <el-form-item :label="$t('table.areaName')" prop="areaName">
...
<script>
  import { fetchList,createInfo,updateInfo,deleteInfo,changeEnableFlag } from '@/api/area'
    ...
    methods: {
      ...
      getList() {
        ...
        fetchList(this.listQuery).then(response => {
          ...
          console.log('查询区域信息返回:' + response.datas);
          setTimeout(() => {
